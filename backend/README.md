...
## Project Structure
    ...
    ├── testapiautoconnect_121284  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_121284`
...
2. Clone this repo and `cd testapiautoconnect_121284`
